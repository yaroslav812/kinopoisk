<?php
	...
	*/
	...
	class ezSQLcore
	{
		...
		var $cache_dir        = false;
		var $cache_slash      = '/'; // added by Yaroslav for local test on OS Windows
		...
		*/
		...
		function ezSQLcore()
		{
			...
			{
				$this->cache_slash = '\\';// added by Yaroslav for local test on OS Windows
			}
		}
		...
		*/
		...
		{
			$cache_file = $this->cache_dir. $this->cache_slash . md5($query);// edited by Yaroslav for local test on OS Windows
